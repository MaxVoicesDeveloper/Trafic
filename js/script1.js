...
function animMoneyAdd(fram){
	var image = document.getElementById('l26');
	image.src = 'ff' + 1 + '.png';
}
$('.body').on("click", function(event){
if (t1 && (l14.style.transform.replace(/[^0-9]/g,"") == 0 || l14.style.transform.replace(/[^0-9]/g,"") == 180)) {
	$("#t1").animate({top: "+=0px"}, 500, function(){animTrain(1);});
	ending += 1;
	t1 = 0;
	if (ending == 6){setTimeout(() => {end();}, 1500);};
};//ready
if (t2 && (l11.style.transform.replace(/[^0-9]/g,"") == 0 || l11.style.transform.replace(/[^0-9]/g,"") == 180) && l19.style.transform.replace(/[^0-9]/g,"") == 270 && (l10.style.transform.replace(/[^0-9]/g,"") == 90 || l10.style.transform.replace(/[^0-9]/g,"") == 270) && (l9.style.transform.replace(/[^0-9]/g,"") == 90 || l9.style.transform.replace(/[^0-9]/g,"") == 270)) {
	$("#t1").animate({top: "+=0px"}, 500, function(){animTrain(2);});
	ending += 1;
	t2 = 0;
	if (ending == 6){setTimeout(() => {end();}, 1500);};
};//ready
if (t3 && (l13.style.transform.replace(/[^0-9]/g,"") == 90 || l13.style.transform.replace(/[^0-9]/g,"") == 270) && (l23.style.transform.replace(/[^0-9]/g,"") == 90 || l23.style.transform.replace(/[^0-9]/g,"") == 270) && l20.style.transform.replace(/[^0-9]/g,"") == 0) {
	$("#t1").animate({top: "+=0px"}, 500, function(){animTrain(3);});
	ending += 1;
	t3 = 0;
	if (ending == 6){setTimeout(() => {end();}, 1500);};
};//ready
if (t4 && l21.style.transform.replace(/[^0-9]/g,"") == 0 && l24.style.transform.replace(/[^0-9]/g,"") == 270 && (l16.style.transform.replace(/[^0-9]/g,"") == 90 || l16.style.transform.replace(/[^0-9]/g,"") == 270) && l18.style.transform.replace(/[^0-9]/g,"") == 0) {
	$("#t1").animate({top: "+=0px"}, 500, function(){animTrain(4);});
	ending += 1;
	t4 = 0;
	if (ending == 6){setTimeout(() => {end();}, 1500);};
};//ready
if (t5 && l21.style.transform.replace(/[^0-9]/g,"") == 0 && l24.style.transform.replace(/[^0-9]/g,"") == 270) {
	$("#t1").animate({top: "+=0px"}, 500, function(){animTrain(5);});
	ending += 1;
	t5 = 0;
	if (ending == 6){setTimeout(() => {end();}, 1500);};
};//ready
if (t6 && l17.style.transform.replace(/[^0-9]/g,"") == 90 && l22.style.transform.replace(/[^0-9]/g,"") == 270 && (l15.style.transform.replace(/[^0-9]/g,"") == 90 || l15.style.transform.replace(/[^0-9]/g,"") == 270) && l27.style.transform.replace(/[^0-9]/g,"") == 0) {
